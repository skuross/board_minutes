...
Present:
Bob Clough, Kathryn Reeve, Ben Dooks, Chris Hilliard in attendance, Bob proxying for Tamarisk Kay.

## 1. Approve minutes for last meeting
Bob Clough, Kathryn Reeve, Ben Dooks, Chris Hilliard have approved the minutes from the last meeting.
...
* slight over-cost purchasing of components, will keep on top of it - BD
* Trello email setup not completed to email when consumables are requested - BC
...
* Need a wider discussion on the layout of the space, as in the short term we won't be adding additional walls
..* Members have commented that putting up original wall plans will close it off
* Need to continue to get members involved in physical infrastructure
..* members have been taking this on, such as Fahad with the doorbell, plans for wiring, RW on the walls etc
...
- Had a few new people, had a few leave
 Standardised emails for Hello and Sorry You've Left have been drafted, edited and finalised
..- will eventually be included in MCP functions
..- need to be stored somewhere other than hackpad, eventually github with MCP
...
- *Bookmarks - BC to talk to previous designer.* - still needs done

### Funding
- *Corporate sponsorship - discuss options*
..- Need to show more projects
....- Can use the wall of the workshop to show off projects
...
- Need to add 'trimmed' HSE document to each tool wiki page where apropreate
...
..- didn't know the details of the paypal, Kat taking over - BC
...
- Teams should be frequently reporting to the hackspace to keep the groups accountable - the method of reporting will be on a forum basis, with an advised format (not required format, as a single format will not always be apropreate)
..- This will require setting up groups in the forum
- Membership to teams is drop-in, drop-out, with no requirement for long-term comitment
...
Kimball voted in as a non-exec director - Bob, Kat, Ben, Chris, Tas in favour, none opposed
...
Last read-over needed, otherwise voted in - Bob, Kat, Ben, Chris in favour, none opposed
...
- Wehave water heater and other bits for kitchen

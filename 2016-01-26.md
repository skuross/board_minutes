...
### Loan Worker Policy (raised by KR)

Loan worker policy applies to all tools with a "this is bloody dangerous" tag. We require this for our insurance to be valid. It **only** applies to these tools.
